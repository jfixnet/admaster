...
<div class="container mt-5" style="width: 450px;">
    ...
    <div class="row mb-3">
        <div class="col-sm-12 text-center">
            <h3><span class="font-bold text-danger">작성자만 글을 수정할 수 있습니다.</span></h3>
        ...
        <div class="col-sm-12">
            <input type="password" id="write_password" name="write_password" class="form-control form-control-sm" autocomplete="off" placeholder="비밀번호">
        </div>
    </div>
