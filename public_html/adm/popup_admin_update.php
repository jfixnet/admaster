...
<div class="container mt-5">
    ...
    <div class="row mb-3">
        ...
        <div class="col-sm-2">
            ...
            <input form="form" type="text" id="popup_width_size" name="popup_width_size" class="form-control form-control-sm" placeholder="기본값 200" autocomplete="off">
        </div>
        <div class="col-sm-2">
            <label class="col-sm-12 form-label"><span class="text-danger"></span> 팝업창 세로 사이즈 (px)</label>
            <input form="form" type="text" id="popup_height_size" name="popup_height_size" class="form-control form-control-sm" placeholder="기본값 200" autocomplete="off">
        </div>
        <div class="col-sm-2">
